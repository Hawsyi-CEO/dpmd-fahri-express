 ...
 */
const uploadDdNonEarmarkedT2Data = async (req, res) => {
  try {
    ...
    const targetFile = path.join(publicDir, 'dd-nonearmarked-tahap2.json');
    ...
    // Move uploaded file to replace dd-nonearmarked-tahap2.json
 ...
 */
const getDdNonEarmarkedT2Data = async (req, res) => {
  try {
    const publicDir = path.join(__dirname, '../../public');
    const targetFile = path.join(publicDir, 'dd-nonearmarked-tahap2.json');
 ...
 */
const getDdNonEarmarkedT2Info = async (req, res) => {
  try {
    const publicDir = path.join(__dirname, '../../public');
    const targetFile = path.join(publicDir, 'dd-nonearmarked-tahap2.json');
    ...
    res.json({
      success: true,
      data: {
        fileName: 'dd-nonearmarked-tahap2.json',
        fileSize: stats.size,
 ...
 */
const getDdNonEarmarkedT2BackupList = async (req, res) => {
  try {
    const publicDir = path.join(__dirname, '../../public');
    const backupDir = path.join(publicDir, 'backups');
...
module.exports = {
  uploadDdNonEarmarkedT2Data,
  getDdNonEarmarkedT2Data,
  getDdNonEarmarkedT2Info,
  getDdNonEarmarkedT2BackupList
};
