// src/controllers/insentif-dd.controller.js
const fs = require('fs').promises;
const path = require('path');

/**
 * Upload and replace insentif-dd.json file
 */
const uploadInsentifDdData = async (req, res) => {
  try {
    ...
    const targetFile = path.join(publicDir, 'insentif-dd.json');
    ...
    // Move uploaded file to replace insentif-dd.json
 ...
 */
const getInsentifDdData = async (req, res) => {
  try {
    const publicDir = path.join(__dirname, '../../public');
    const targetFile = path.join(publicDir, 'insentif-dd.json');
 ...
 */
const getInsentifDdInfo = async (req, res) => {
  try {
    const publicDir = path.join(__dirname, '../../public');
    const targetFile = path.join(publicDir, 'insentif-dd.json');
 ...
 */
const getInsentifDdBackupList = async (req, res) => {
  try {
    const publicDir = path.join(__dirname, '../../public');
    const backupDir = path.join(publicDir, 'backups');
...
module.exports = {
  uploadInsentifDdData,
  getInsentifDdData,
  getInsentifDdInfo,
  getInsentifDdBackupList
};
