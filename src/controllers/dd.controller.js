// src/controllers/dd.controller.js
const fs = require('fs').promises;
const path = require('path');

/**
 * Upload and replace dd2025.json file
 */
const uploadDdData = async (req, res) => {
  try {
    ...
    const targetFile = path.join(publicDir, 'dd2025.json');
    ...
    // Move uploaded file to replace dd2025.json
