...
class KelembagaanController {
  ...
  async summaryByDesa(req, res) {
    try {
      const { id } = req.params;
      const desa = await prisma.desas.findUnique({ where: { id: parseInt(id) } });
      ...
      res.json({
        success: true,
        data: {
          desa: { id: desa.id, nama: desa.nama, status_pemerintahan: desa.status_pemerintahan },
  ...
  async getDesaRW(req, res) {
    try {
      ...
      const rws = await prisma.rws.findMany({
        where: { desa_id: parseInt(id) },
        include: { desas: { select: { nama: true, id: true, kecamatans: { select: { nama: true } } } } },
        orderBy: { nomor: 'asc' }
      });
      ...
      res.json({
        ...
        data: rws.map(rw => ({
          ...
          desa: { id: rw.desas.id, nama: rw.desas.nama, kecamatan: rw.desas.kecamatans.nama }
        }))
      });
    } catch (error) {
  ...
  async listRT(req, res) {
    try {
      ...
      const rts = await prisma.rts.findMany({
        where,
        include: { desas: { select: { nama: true, kecamatans: { select: { nama: true } } } }, rws: { select: { nomor: true } } },
      ...
      res.json({
        ...
        data: rts.map(rt => ({
          ...
          desa: { id: rt.desas.id, nama: rt.desas.nama, kecamatan: rt.desas.kecamatans.nama }
        }))
      });
    } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        data: posyandus.map(p => ({
          ...
          desa: { id: p.desas.id, nama: p.desas.nama, kecamatan: p.desas.kecamatans.nama }
        }))
      });
    } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        data: karangTarunas.map(kt => ({
          ...
          desa: { id: kt.desas.id, nama: kt.desas.nama, kecamatan: kt.desas.kecamatans.nama }
        }))
      });
    } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        data: lpms.map(lpm => ({
          ...
          desa: { id: lpm.desas.id, nama: lpm.desas.nama, kecamatan: lpm.desas.kecamatans.nama }
        }))
      });
    } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        data: satlinmas.map(s => ({
          ...
          desa: { id: s.desas.id, nama: s.desas.nama, kecamatan: s.desas.kecamatans.nama }
        }))
      });
    } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        data: pkks.map(pkk => ({
          ...
          desa: { id: pkk.desas.id, nama: pkk.desas.nama, kecamatan: pkk.desas.kecamatans.nama }
        }))
      });
    } catch (error) {
  ...
  async showRW(req, res) {
    try {
      ...
      const rw = await prisma.rws.findUnique({
        where: { id: parseInt(id) },
        include: {
          desas: { select: { id: true, nama: true, kecamatans: { select: { nama: true } } } },
    ...
    try {
      ...
      res.json({
        ...
        data: {
          ...
          desa: { id: posyandu.desas.id, nama: posyandu.desas.nama, kecamatan: posyandu.desas.kecamatans.nama }
        }
      });
    } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        data: {
          ...
          desa: { id: karangTaruna.desas.id, nama: karangTaruna.desas.nama, kecamatan: karangTaruna.desas.kecamatans.nama }
        }
      });
    } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        data: {
          ...
          desa: { id: satlinmas.desas.id, nama: satlinmas.desas.nama, kecamatan: satlinmas.desas.kecamatans.nama }
        }
      });
    } catch (error) {
