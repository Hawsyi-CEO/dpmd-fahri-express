...
router.post('/upload', auth, checkRole('superadmin', 'sarana_prasarana', 'kekayaan_keuangan'), upload.single('file'), ddNonEarmarkedT1Controller.uploadDdNonEarmarkedT1Data);
...
router.get('/backups', auth, checkRole('superadmin', 'sarana_prasarana'), ddNonEarmarkedT1Controller.getDdNonEarmarkedT1BackupList);
